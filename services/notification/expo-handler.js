...
class ExpoHandler {
  ...
  constructor() {
    if (!ExpoHandler.instance) {
      ...
      this.previousUnsentNotifications = [];
  ...
  addUnsentNotifications(notification) {
    this.unsentNotifications.push(notification);
  }

  //prettier-ignore
  run() {
    if (!this.unsentNotifications.every(e => this.previousUnsentNotifications.includes(e))) {
      console.log("Received one new notification!");
      console.log(this.unsentNotifications);
      this.previousUnsentNotifications.splice(0, this.previousUnsentNotifications.length);
      this.previousUnsentNotifications.push(...this.unsentNotifications);
    }
